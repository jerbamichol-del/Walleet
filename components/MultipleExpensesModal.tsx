...
const MultipleExpensesModal: React.FC<MultipleExpensesModalProps> = ({ isOpen, onClose, expenses, onConfirm }) => {
        ...
        <div className="p-6 max-h-[60vh] overflow-y-auto">
            ...
            <div className="space-y-3">
                {editableExpenses.map((expense, index) => {
                    ...
                    const availableSubcategories = expense.category ? CATEGORIES[expense.category as keyof typeof CATEGORIES] : [];
